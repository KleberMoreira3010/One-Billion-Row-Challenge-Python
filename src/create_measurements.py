...
def build_weather_station_name_list():
    ...
    """
    station_names = []
    with open('One-Billion-Row-Challenge-Python\data\weather_stations.csv', 'r', encoding="utf-8") as file:
...
def build_test_data(weather_station_names, num_rows_to_create):
    ...
    try:
        with open("One-Billion-Row-Challenge-Python\data\weather_stations.csv", 'w', encoding="utf-8") as file:
    ...
    file_size = os.path.getsize("One-Billion-Row-Challenge-Python\data\weather_stations.csv")
    human_file_size = convert_bytes(file_size)
 
    print("Arquivo escrito com sucesso data/measurements.csv")
