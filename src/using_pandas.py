...
filename = "E:\Python\Python_Bootcamp\one_billion_row\One-Billion-Row-Challenge-Python\data\weather_stations.csv"  # Certifique-se de que este é o caminho correto para o arquivo
